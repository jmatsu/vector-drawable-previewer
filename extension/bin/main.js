...
"use strict";
var vector_drawable_conveter_1 = require("./vector_drawable_conveter");
var vector_drawable_node_retriever_1 = require("./vector_drawable_node_retriever");
var Main = (function () {
    function Main() {
    }
    Main.prototype.onLoad = function () {
        var nodeRetriever = new vector_drawable_node_retriever_1.VectorDrawableNodeRetriever();
        var converter = new vector_drawable_conveter_1.VectorDrawableConverter();
        nodeRetriever.fetch().then(function (e) {
...
},{"./vector_drawable_conveter":4,"./vector_drawable_node_retriever":5}],4:[function(require,module,exports){
"use strict";
var es6_promise_1 = require("es6-promise");
var VectorDrawableConverter = (function () {
    function VectorDrawableConverter() {
    }
    VectorDrawableConverter.prototype.convert = function (vd) {
...
var Impl = (function () {
    ...
    Impl.prototype.convertVD2SVG = function (vd) {
...
var VectorDrawableNodeRetriever = (function () {
    ...
    VectorDrawableNodeRetriever.prototype.fetch = function () {
...
var Impl = (function () {
    ...
    Impl.prototype.mayGetNode = function () {
